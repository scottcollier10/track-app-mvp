...
export default function DriverComparisonTable({
  ...
  console.log("🔍 Current sort state:", { sortField, sortDirection, comparisonLength: comparison.length });
  ...
  const sortedData = useMemo(() => {
    console.log("🔄 Sorting data with:", { sortField, sortDirection });
  ...
  console.log("✅ Sorted data (first 3):", sortedData.slice(0, 3).map(d => ({
    name: d.driverName,
    date: d.lastSessionDate,
    bestLap: d.bestLapMs
  })));

  const handleSort = (field: SortField) => {
    console.log("🖱️ SORT CLICKED:", field);
    ...
    if (sortField === field) {
      ...
      setSortField(field);
      const newDirection = field === "driverName" || field === "trackName" ? "asc" : "desc";
          ...
          <thead className="bg-gray-50 dark:bg-gray-900">
            <tr>
              <th
                ...
                onClick={() => {
                  console.log("👆 Driver header clicked");
              ...
              {!selectedTrackId && (
                <th
                  ...
                  className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                  onClick={() => {
                    console.log("👆 Track header clicked");
              ...
              <th
                ...
                className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                onClick={() => {
                  console.log("👆 Best Lap header clicked");
                  handleSort("bestLapMs");
                }}
              >
                Best Lap
              ...
              <th
                ...
                className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                onClick={() => {
                  console.log("👆 Sessions header clicked");
                  handleSort("sessionCount");
                }}
              >
                Sessions
              ...
              <th
                ...
                className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                onClick={() => {
                  console.log("👆 Total Laps header clicked");
                  handleSort("totalLaps");
                }}
              >
                Total Laps
              ...
              <th
                ...
                className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                onClick={() => {
                  console.log("👆 Last Session header clicked");
                  handleSort("lastSessionDate");
                }}
              >
                Last Session
